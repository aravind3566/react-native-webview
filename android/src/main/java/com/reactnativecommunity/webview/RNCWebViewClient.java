...
public class RNCWebViewClient extends WebViewClient {
    ...
    public void onReceivedSslError(final WebView webView, final SslErrorHandler handler, final SslError error) {
        // Show a Toast message to inform the user about the SSL issue
        Toast.makeText(webView.getContext(), "SSL Certificate Error: Proceeding may be unsafe.", Toast.LENGTH_SHORT).show();
    
        // Optionally proceed or cancel based on your app's requirements
        handler.proceed(); // Proceed with the connection
        // handler.cancel(); // Cancel the connection if you want stricter security
    }
